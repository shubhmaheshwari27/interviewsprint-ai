...
4. **AI Analysis**: Go to an application's details page and click "Generate AI Analysis". The system will use OpenAI to generate custom interview questions, identify skill gaps, and more.
...
### 3. AI Engine
- **OpenAI GPT-4o**: Integrated via the OpenAI SDK.
...
- [ai.ts](file:///d:/Antigravity%20Projects/InterviewSprint%20AI/actions/ai.ts): AI analysis logic.
...
- Enable **OpenAI API Key** in your production environment.
